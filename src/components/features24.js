          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">Secure Payments</span>
                  </Fragment>
                )}
              </h2>
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text2">Dedicated Support</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
...
Features24.defaultProps = {
  feature1ImgAlt: 'Secure Transactions',
  ...
  feature3ImgAlt: 'Customer Support',
